...
Seq[Any](format.raw/*1.91*/("""
    ...
    """),_display_(Seq[Any](/*104.6*/main("Search Service",email,scripts)/*104.42*/{_display_(Seq[Any](format.raw/*104.43*/("""
        ...
        """),_display_(Seq[Any](/*106.10*/flash_message())),format.raw/*106.25*/("""
        """),format.raw/*107.62*/("""
        """),_display_(Seq[Any](/*108.10*/form(routes.ClimateServiceController.getSearchServiceResult(email))/*108.77*/ {_display_(Seq[Any](format.raw/*108.79*/("""
            """),format.raw/*109.108*/("""
            <div class="ui-widget col-sm-offset-3 col-sm-7 col-md-offset-3 col-md-7 col-lg-offset-3 col-lg-7">
                <div class = "form-group" align="center" >
                    """),_display_(Seq[Any](/*112.22*/inputText(climateServiceForm("Search"), 'class -> "form-control",'id -> "serviceName", 'placeholder -> "Service Name", 'size->70))),format.raw/*112.151*/("""
                    <input type="text" class="hidden" name="email" value="""),_display_(Seq[Any](/*113.75*/email)),format.raw/*113.80*/(""">
                </div>
                <div align="center">
