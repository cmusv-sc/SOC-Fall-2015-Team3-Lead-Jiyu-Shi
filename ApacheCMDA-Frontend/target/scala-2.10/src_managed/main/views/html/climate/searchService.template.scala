...
Seq[Any](format.raw/*1.91*/("""
    ...
    """),_display_(Seq[Any](/*104.6*/main("Search Service",email,scripts)/*104.42*/{_display_(Seq[Any](format.raw/*104.43*/("""
        ...
        """),_display_(Seq[Any](/*107.10*/flash_message())),format.raw/*107.25*/("""
        """),format.raw/*108.62*/("""
        """),_display_(Seq[Any](/*109.10*/form(routes.ClimateServiceController.getSearchServiceResult(email))/*109.77*/ {_display_(Seq[Any](format.raw/*109.79*/("""
            """),format.raw/*110.108*/("""
            <div class="ui-widget col-sm-offset-3 col-sm-7 col-md-offset-3 col-md-7 col-lg-offset-3 col-lg-7">
                <div class = "form-group" align="center" >
                    """),_display_(Seq[Any](/*113.22*/inputText(climateServiceForm("Search"), 'class -> "form-control",'id -> "serviceName", 'placeholder -> "Service Name", 'size->70))),format.raw/*113.151*/("""
                    <input type="text" class="hidden" name="email" value="""),_display_(Seq[Any](/*114.75*/email)),format.raw/*114.80*/(""">
                </div>
                <div align="center">
    ...
    def ref: this.type = this
                ...
                /*
                    -- GENERATED --
                    DATE: Sat Dec 05 14:25:56 EST 2015
